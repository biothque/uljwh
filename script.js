// Remplace ici par tes propres identifiants Backendless :
const APP_ID = "TON_APP_ID";
const API_KEY = "TA_REST_API_KEY";
...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        message.textContent = "❌ Une erreur est survenue. Vérifie ta connexion.";
